...
categories: ["Pytorch"]
summary: "本篇文章提供了 [Sasha Rush](https://github.com/srush) 的 [GPU Puzzles](https://github.com/srush/GPU-Puzzles) 的解决方案"
---

## Summary

本篇文章提供了 [Sasha Rush](https://github.com/srush) 的 [GPU Puzzles](https://github.com/srush/GPU-Puzzles) 的解决方案。

对于一些困难的题目，我们给出了注释帮助理解。
