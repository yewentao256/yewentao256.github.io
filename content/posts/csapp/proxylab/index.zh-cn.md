...
categories: ["csapp"]
summary: "在proxy lab中，我们构建了一个简单的web proxy，包含多线程处理并发请求和一个LRU cache快速返回静态资源。"
---

## Summary

在proxy lab中，我们构建了一个简单的web proxy，包含多线程处理并发请求和一个LRU cache快速返回静态资源。源码：[Github-Link-Here](https://github.com/yewentao256/CSAPP_15213/tree/main/proxylab)
